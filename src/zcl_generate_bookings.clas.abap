CLASS zcl_generate_bookings DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_bookings IMPLEMENTATION.
...
* Insert the new table entries
    INSERT ztbooking
    FROM TABLE @it_bookings.

* Check the result
    SELECT * FROM ztbooking
    INTO TABLE @it_bookings.

    out->write( sy-dbcnt ).
    out->write( 'Log: Data inserted successfully!').
